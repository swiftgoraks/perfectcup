...
<head>
    ...
    <title>The perfect cut about ut</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <iframe src='https://www.youtube.com/embed/BUF_BGkZh4I' frameborder='0' allowfullscreen></iframe></div>
                </div>
                <div class="col-md-6">
                    <p>
                    Paragrah here
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/one.jpg" alt="">
                    <h3>John Smith
