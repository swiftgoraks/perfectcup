                ...
                $.ajax({
                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Error</strong> processinga request. Please try again. \ \
                                                 </div>');
                        }
                    },
                    beforeSend: function () {
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Contact
                        <strong>Jose Munguia</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-8">
                    <!-- Embedded Google Map using an iframe - to select your location find it on Google maps and paste the link as the iframe src. If you want to use the Google Maps API instead then have at it! -->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62023.09833004588!2d-89.25027146202835!3d13.691559132444729!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f633067b411775d%3A0x1f75978893fb5c96!2sSan%20Salvador!5e0!3m2!1ses-419!2ssv!4v1596401874027!5m2!1ses-419!2ssv" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="col-md-4">
                    <p>Phone:
                        <strong>6013-5555</strong>
                    </p>
                    <p>Email:
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Jose Munguia</p>
                </div>
            </div>
        </div>
    </footer>
